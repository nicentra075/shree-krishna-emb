...
class HomeFeedConfig {
  ...
  factory HomeFeedConfig.fromFirebaseJson(Map<String, dynamic> json) {
    ...
    return HomeFeedConfig(
      ...
      updatedAt:
          json['updatedAt'] != null ? parseTimestamp(json['updatedAt']) : null,
      sections: sections,
    );
  }
        ...
        sections: [
          ...
          const HomeSectionConfig(
            ...
            source: HomeSourceConfig(
                kind: HomeSourceKind.authorisedSellers, limit: 12),
          ),
          const HomeSectionConfig(
            id: 'trending-1',
            ...
            source: HomeSourceConfig(
                kind: HomeSourceKind.query, sort: 'popularity', limit: 10),
          ),
          const HomeSectionConfig(
            id: 'collections-1',
          ...
          const HomeSectionConfig(
            ...
            position: 4,
            source: HomeSourceConfig(
                kind: HomeSourceKind.recentlyViewed, limit: 10),
          ),
        ],
      );
